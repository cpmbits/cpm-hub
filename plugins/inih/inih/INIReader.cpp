...
std::string INIReader::Get(const std::string &name) const
{
    return Get("", name, "");
}
...
long INIReader::GetInteger(const string& name) const
{
...
bool INIReader::GetBoolean(const std::string &name) const
{
